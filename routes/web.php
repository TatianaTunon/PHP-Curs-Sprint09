...
Route::match(['put', 'patch'], '/paises/{paises}', [paisController::class, 'update'])->name ('update');
...
Route::match(['put', 'patch'],'/paises/{paises}/departamento/{departamento}', [DepartamentoController::class, 'update'])->name ('update');
